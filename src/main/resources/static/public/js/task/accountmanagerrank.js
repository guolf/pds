$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
			...
			{ label: '成功率', name: 'taskSuccessRatio', index: 'task_success_ratio', width: 80 },
			{ label: '失败数', name: 'taskFailNum', index: 'task_fail_num', width: 80 },
			{ label: '失败率', name: 'taskFailRatio', index: 'task_fail_ratio', width: 80 },
			{ label: '未完成数', name: 'taskIncompleteNum', index: 'task_incomplete_num', width: 80 },
			{ label: '未完成率', name: 'taskIncompleteRatio', index: 'task_incomplete_ratio', width: 80 },
